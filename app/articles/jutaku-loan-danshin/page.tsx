    ...
    <main className="min-h-screen bg-slate-900 text-white">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <nav className="text-xs text-slate-500 mb-6 flex items-center gap-1">
          ...
          <span>/</span>
          <span className="text-slate-300">住宅ローン団信</span>
        </nav>
        ...
        <section className="mb-10">
          ...
          <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/20 mb-4">
            <p className="text-sm font-bold text-blue-200 mb-2">団信の基本補償</p>
        ...
        <section className="mb-10">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-slate-800">
                  <th className="text-left px-4 py-3 font-bold text-slate-200 border-b border-slate-700">種類</th>
                  <th className="text-left px-4 py-3 font-bold text-slate-200 border-b border-slate-700">補償内容</th>
                  <th className="text-right px-4 py-3 font-bold text-slate-200 border-b border-slate-700">上乗せ金利目安</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? "bg-slate-800" : "bg-slate-700/30"}>
                    <td className="px-4 py-3 font-semibold text-white text-xs">{row.type}</td>
                    <td className="px-4 py-3 text-xs text-slate-300">{row.cover}</td>
          ...
          <p className="text-xs text-slate-500">※上乗せ金利は金融機関・商品により異なります。2025年5月時点の参考値です。</p>
        </section>
          ...
          <div className="space-y-3 mb-4">
            {[
              ...
              <div key={i} className={`rounded-xl p-4 border ${item.bg}`}>
                <p className="text-sm font-bold text-white mb-1">⚠️ {item.title}</p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-blue-500/10 rounded-xl p-5 border border-blue-500/20 mb-4">
            <p className="text-sm font-bold text-blue-200 mb-3">ライフステージ別おすすめ</p>
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="bg-slate-800 rounded-xl p-4 border border-blue-500/20">
                  <p className="text-sm font-bold text-white mb-1">👤 {item.stage}</p>
                  <p className="text-xs font-semibold text-blue-300 mb-1">おすすめ：{item.recommend}</p>
