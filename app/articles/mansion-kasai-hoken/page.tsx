    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex items-center gap-1">
          ...
          <span>/</span>
          <span className="text-gray-600">マンション火災保険</span>
        </nav>

        <div className="flex items-center gap-2 mb-3">
          <span className="text-xs bg-blue-50 text-blue-700 font-semibold px-2 py-0.5 rounded-full">火災保険・保険</span>
          <span className="text-xs text-gray-400">2025年最新</span>
        </div>

        <h1 className="text-2xl font-black text-gray-900 leading-tight mb-4">
          マンション購入時の<span className="text-blue-600">火災保険はいくら？</span><br />
          必要性と相場を解説
        </h1>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">補償対象</th>
                  <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">内容</th>
                  <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">誰が加入？</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50/50"}>
                    <td className="px-4 py-3 font-semibold text-gray-900 text-xs">{row.target}</td>
                    <td className="px-4 py-3 text-xs text-gray-600">{row.content}</td>
                    <td className="px-4 py-3 text-xs text-blue-700 font-semibold">{row.who}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-2xl p-5 mb-10">
          <p className="text-xs font-bold text-orange-700 mb-1">🔥 火災保険、比較してますか？</p>
          <p className="text-sm font-black text-gray-900 mb-2">複数社を一括見積もりで比較できる「火災保険一括見積もり」</p>
          <p className="text-xs text-gray-600 mb-3">回答者全員にセブンプレミアムカフェラテをプレゼント。無料で最安値を確認できます。</p>
          <a
        ...
        <section className="mb-10">
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-200 mb-4">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">補償内容・プラン</th>
                  <th className="text-right px-4 py-3 font-bold text-gray-700 border-b border-gray-200">年間保険料目安</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50/50"}>
                    <td className="px-4 py-3 text-xs text-gray-700">{row.plan}</td>
          ...
          <p className="text-xs text-gray-400 mb-4">※物件の築年数・構造・所在地・補償内容により大きく異なります。実際には見積もりで確認してください。</p>
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
            <p className="text-sm font-bold text-blue-800 mb-1">💡 長期契約でコストを抑える</p>
            <p className="text-xs text-gray-600 leading-relaxed">
