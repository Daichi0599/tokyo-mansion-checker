    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex items-center gap-1">
          ...
          <span>/</span>
          <span className="text-gray-600">買ってはいけないマンション</span>
        </nav>

        <div className="flex items-center gap-2 mb-3">
          <span className="text-xs bg-blue-50 text-blue-700 font-semibold px-2 py-0.5 rounded-full">物件選び・失敗回避</span>
          <span className="text-xs text-gray-400">2025年最新</span>
        </div>

        <h1 className="text-2xl font-black text-gray-900 leading-tight mb-4">
          <span className="text-red-600">買ってはいけないマンション</span>の特徴10選<br />
          立地・建物・管理で後悔しない選び方
        </h1>
        ...
        <div className="bg-red-50 border border-red-200 rounded-2xl p-5 mb-10">
          <p className="text-sm font-black text-red-700 mb-3">⚠️ この記事でわかること</p>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-black text-gray-900 mb-4 pb-2 border-b-2 border-red-100">
            🚩 立地で買ってはいけないマンションの特徴
          </h2>
          <div className="space-y-4">

            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❶ 駅徒歩15分超（特に坂あり）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                徒歩15分超の物件は、資産価値の下落スピードが速く、将来の売却・賃貸が難しくなります。特に坂がある場合、雨の日・真夏・高齢化後の生活が想像以上に辛くなります。
              </p>
              <div className="bg-gray-50 rounded-lg px-3 py-2">
                <p className="text-xs text-gray-500">📌 目安：<strong className="text-gray-700">徒歩10分以内が理想。15分超は資産価値維持が困難</strong></p>
              </div>
            </div>

            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❷ 将来の開発・環境変化リスクがある立地</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
              ...
              <div className="bg-yellow-50 rounded-lg px-3 py-2">
                <p className="text-xs text-yellow-800">📌 確認方法：市区町村の<strong>用途地域マップ</strong>・<strong>都市計画情報</strong>をWebで確認</p>
              </div>
            </div>

            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❸ ハザードマップの浸水・土砂エリア</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                近年の豪雨・台風で浸水被害が増加。ハザードマップで浸水想定エリアに入る物件は、将来の保険料上昇・売却困難につながります。特に低層階（1〜2階）は要注意。
              </p>
              <div className="bg-blue-50 rounded-lg px-3 py-2">
                <p className="text-xs text-blue-800">📌 確認方法：<strong>国土交通省ハザードマップポータル</strong>で無料確認可能</p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❹ 旧耐震基準（1981年6月以前の建物）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                1981年6月以前に建築確認を受けた建物は旧耐震基準。住宅ローン控除が受けられないケースがあり、銀行融資も受けにくい物件があります。耐震診断を確認しましょう。
              </p>
              <div className="bg-red-50 rounded-lg px-3 py-2">
                <p className="text-xs text-red-800">⚠️ 住宅ローン控除を受けるには<strong>新耐震基準適合証明書</strong>または<strong>耐震基準適合証明書</strong>が必要</p>
              </div>
            </div>

            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❺ 総戸数が少なすぎる（20戸未満）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                総戸数が少ないと管理費・修繕積立金を少人数で分担するため一戸あたり費用が高くなります。また管理組合が機能しにくく、大規模修繕の合意形成が難しいケースも。
              </p>
              <div className="bg-gray-50 rounded-lg px-3 py-2">
                <p className="text-xs text-gray-500">📌 目安：<strong className="text-gray-700">50戸以上が管理コスト・修繕費のバランスが取りやすい</strong></p>
              </div>
            </div>

            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❻ 北向き・採光・通風が極端に悪い住戸</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                北向き住戸は日当たりが悪く、冬の光熱費が高くなる・結露・カビのリスクがあります。また、隣のビルとの距離が近すぎる物件は、昼間でも薄暗く体感的な快適性が低下します。
              </p>
              <div className="bg-gray-50 rounded-lg px-3 py-2">
                <p className="text-xs text-gray-500">📌 確認方法：晴れた日の午前・午後に内覧し、実際の日当たりを体感で確認</p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❼ 修繕積立金が異常に安い（月3,000円以下）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="text-left px-3 py-2 font-bold text-gray-600">専有面積</th>
                      <th className="text-right px-3 py-2 font-bold text-green-700">適正な積立目安</th>
                      <th className="text-right px-3 py-2 font-bold text-red-700">危険なライン</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50/50"}>
                        <td className="px-3 py-2 font-medium text-gray-700">{row.area}</td>
                        <td className="px-3 py-2 text-right text-green-700 font-semibold">{row.ok}</td>
                        <td className="px-3 py-2 text-right text-red-600 font-semibold">{row.ng}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❽ 管理組合が機能していない（議事録が空白・総会未開催）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                管理組合の議事録（過去3〜5年分）に空白期間がある、総会が未開催の物件は管理が機能していない危険サイン。修繕計画の合意形成も難しく、建物の老朽化が進みやすくなります。
              </p>
              <div className="bg-yellow-50 rounded-lg px-3 py-2">
                <p className="text-xs text-yellow-800">📌 確認方法：重要事項説明書に含まれる<strong>管理組合の財務状況・議事録</strong>を必ず確認</p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❾ 周辺相場より明らかに高い（坪単価が10%超高い）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-sm font-black text-red-700 mb-2">❿ 売り急ぎのサインがある物件（価格が急落・長期在庫）</p>
              <p className="text-xs text-gray-600 leading-relaxed mb-2">
                SUUMO掲載から6ヶ月以上経過・価格を2回以上下げている物件は、何らかの問題（近隣トラブル・欠陥・管理問題）を抱えている可能性があります。「なぜ売れていないか」を必ず確認しましょう。
              </p>
              <div className="bg-gray-50 rounded-lg px-3 py-2">
                <p className="text-xs text-gray-500">📌 確認方法：掲載日・価格変更履歴をSUUMOの物件詳細ページで確認できます</p>
              </div>
            </div>
