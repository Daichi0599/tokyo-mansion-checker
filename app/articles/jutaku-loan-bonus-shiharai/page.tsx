    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex items-center gap-1">
          ...
          <span>/</span>
          <span className="text-gray-600">住宅ローンのボーナス払い</span>
        </nav>

        <div className="flex items-center gap-2 mb-3">
          <span className="text-xs bg-blue-50 text-blue-700 font-semibold px-2 py-0.5 rounded-full">ボーナス払い・住宅ローン</span>
          <span className="text-xs text-gray-400">2025年最新</span>
        </div>

        <h1 className="text-2xl font-black text-gray-900 leading-tight mb-4">
          住宅ローンの<span className="text-blue-600">ボーナス払いはやめておくべき？</span><br />
          リスクと対策を解説
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-100 mb-4">
            <p className="text-sm font-bold text-blue-800 mb-3">計算例：4,000万円・35年・金利0.5%</p>
            <div className="space-y-2">
              {[
                ...
                <div key={i} className="bg-white rounded-lg p-3">
                  <p className="text-xs font-bold text-gray-800 mb-1">{row.label}</p>
                  <div className="flex gap-4 text-xs text-gray-600">
                    <span>毎月: <strong className="text-blue-700">{row.monthly}</strong></span>
                    <span>ボーナス: <strong className="text-orange-600">{row.bonus}</strong></span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-3 mb-4">
            {[
              ...
              <div key={i} className={`rounded-xl p-4 border ${item.bg}`}>
                <p className="text-sm font-black text-gray-900 mb-1">STEP {item.icon}: {item.title}</p>
        ...
        <div className="bg-green-50 border border-green-200 rounded-2xl p-5 mb-10">
          <p className="text-xs font-bold text-green-700 mb-1">💡 ボーナスに頼らない返済プランを相談したい方へ</p>
          <p className="text-sm font-black text-gray-900 mb-2">「モゲチェック」で最適な住宅ローンを無料診断</p>
        ...
        <section className="mb-10">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="text-left px-4 py-3 font-bold text-gray-700 border-b border-gray-200">比較項目</th>
                  <th className="text-center px-4 py-3 font-bold text-orange-700 border-b border-gray-200">ボーナス払い設定</th>
                  <th className="text-center px-4 py-3 font-bold text-green-700 border-b border-gray-200">均等払い＋繰り上げ返済</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50/50"}>
                    <td className="px-4 py-3 text-xs font-semibold text-gray-700">{row.item}</td>
                    <td className="px-4 py-3 text-center text-xs text-orange-700">{row.bonus}</td>
                    <td className="px-4 py-3 text-center text-xs text-green-700">{row.kuriage}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
            <p className="text-xs font-bold text-blue-800 mb-1">結論：ボーナスが不確定なら「均等払い＋任意繰り上げ」がベター</p>
            <p className="text-xs text-gray-600">月々の返済額を固定し、ボーナスが出た年だけ繰り上げ返済する方が、資金繰りの柔軟性と利息削減を両立できます。</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-2">
            ...
            <Link href="/articles/jutaku-loan-karikaee" className="flex items-center gap-3 bg-white rounded-xl p-3 border border-gray-100 hover:border-blue-200 transition-colors group">
              <span className="text-xl">🔄</span>
              <span className="text-sm text-gray-700 group-hover:text-blue-600">住宅ローンの借り換えで得する人・損する人【損益分岐点を計算】</span>
            </Link>
          </div>
        </section>
