      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        <div className="bg-slate-800 rounded-2xl  border border-slate-700 p-8">
          ...
          <div className="prose prose-sm max-w-none text-slate-200 space-y-8">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">3. Cookieの使用</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">4. Google Analytics について</h2>
              <p>
              ...
              <p className="mt-2">
                ...
                <a href="https://marketingplatform.google.com/about/analytics/terms/jp/" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">こちら</a>
                をご確認ください。
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-white mb-3">5. Google AdSense について</h2>
              <p>
              ...
              <p className="mt-2">
                ユーザーはGoogleの広告設定ページ（
                <a href="https://adssettings.google.com/" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">https://adssettings.google.com/</a>
                ）でパーソナライズ広告を無効にすることができます。
                詳細はGoogleの
                <a href="https://policies.google.com/privacy?hl=ja" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">プライバシーポリシー</a>
                をご参照ください。
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-white mb-3">6. アフィリエイトプログラムについて</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">7. 個人情報の第三者提供</h2>
              <p>
            ...
            <section>
              ...
              <p className="mt-2 font-mono text-sm bg-slate-800 px-3 py-2 rounded-lg inline-block">
