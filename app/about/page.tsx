      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        <div className="bg-slate-800 rounded-2xl  border border-slate-700 p-8">
          ...
          <div className="prose prose-sm max-w-none text-slate-200 space-y-8">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">サイトの目的</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">運営者情報</h2>
              <div className="bg-slate-800 rounded-xl p-5 space-y-3">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300 mt-1">大企業勤務・アラサー・都内在住</p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">提供ツール一覧</h2>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-xl">🏠</span>
                  <div>
                    <Link href="/mansion" className="font-semibold text-blue-400 hover:underline">マンション購入診断</Link>
                    <p className="text-sm text-slate-300">年収・生活費・金利から「無理なく買える価格」を算出。返済比率・負担率のチェックも可能。</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-xl">🔍</span>
                  <div>
                    ...
                    <p className="text-sm text-slate-300">気になる物件の坪単価・管理費・修繕積立金の適正チェック＋10年後の推定売却価格を算出。</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-xl">🚗</span>
                  <div>
                    ...
                    <p className="text-sm text-slate-300">購入・ローン・カーシェア・リースを10年総コストで比較。都内在住者向けの現実的なコスト計算。</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-xl">👶</span>
                  <div>
                    ...
                    <p className="text-sm text-slate-300">0歳〜22歳の子育て費用を進路パターン別にシミュレーション。</p>
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">コンテンツの信頼性について</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">お問い合わせ</h2>
              <p>
